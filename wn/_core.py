...
class _LexiconElement(_HasMetadata, Protocol):
    ...
    def confidence(self: _HasMetadata) -> float:
...
class _LexiconDataElement(_LexiconElement):
...
class Relation(_LexiconElement):
